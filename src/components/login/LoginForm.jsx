        ...
        <form className="transition-opacity duration-300" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col justify-center items-center gap-3 p-2">
                ...
                <button
                    ...
                    className="w-full flex items-center justify-center gap-2 p-2.5 rounded-full bg-white text-[#333] text-sm font-medium cursor-pointer transition hover:bg-gray-100"
                >
                    <GoogleIcon size={18} />
                    Sign in with Google
                </button>
            ...
            <p className="text-center mt-3.5 text-xs text-[#ccc]">
                ...
                <a onClick={toggleForm} className="text-[#ff2e88] hover:tracking-wider font-bold cursor-pointer no-underline">
                    Register
                </a>
            </p>
        </form>
