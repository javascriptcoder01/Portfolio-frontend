...
import { deleteAboutRequest, fetchAboutsRequest, statusAboutRequest } from "../../../redux/slices/aboutSlice";


const AboutList = () => {
    const dispatch = useDispatch();
    const { abouts, actionLoading } = useSelector((state) => state.about);
    ...
    const handleDelete = (id) => {
        if (window.confirm("Are you sure want to delete")) {
            dispatch(deleteAboutRequest(id));
        }
    }
