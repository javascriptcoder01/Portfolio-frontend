...
import { deleteExperienceRequest, fetchExperiencesRequest, statusExperienceRequest } from "../../../redux/slices/experienceSlice";

const ExperienceList = () => {
    const dispatch = useDispatch();
    const { experiences, actionLoading } = useSelector((state) => state.experience);
    ...
    const handleStatusToggle = (item) => {
        dispatch(statusExperienceRequest({ id: item._id, isActive: !item.isActive }));
    };
