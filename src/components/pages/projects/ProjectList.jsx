...
import { deleteProjectRequest, fetchProjectsRequest, statusProjectRequest } from "../../../redux/slices/projectSlice";

const ProjectList = () => {
    const dispatch = useDispatch();
    const { projects, actionLoading } = useSelector((state) => state.project);
    ...
    const handleStatusToggle = (item) => {
        dispatch(statusProjectRequest({ id: item._id, isActive: !item.isActive }));
    };
