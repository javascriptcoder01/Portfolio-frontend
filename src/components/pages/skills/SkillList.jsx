...
import { deleteSkillRequest, fetchSkillsRequest, statusSkillRequest } from "../../../redux/slices/skillSlice";

const SkillList = () => {
    const dispatch = useDispatch();
    const { skills, actionLoading } = useSelector((state) => state.skill);
    ...
    const handleStatusToggle = (item) => {
        dispatch(statusSkillRequest({ id: item._id, isActive: !item.isActive }));
    };
