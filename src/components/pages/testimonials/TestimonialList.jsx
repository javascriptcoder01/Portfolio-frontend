...
import { deleteTestimonialRequest, fetchTestimonialsRequest, statusTestimonialRequest } from "../../../redux/slices/testimonialSlice";

const TestimonialList = () => {
    const dispatch = useDispatch();
    const { testimonials, actionLoading } = useSelector((state) => state.testimonial);
    ...
    const handleStatusToggle = (item) => {
        dispatch(statusTestimonialRequest({ id: item._id, isActive: !item.isActive }));
    };
